...
const ContainerBlueList = () => {
  ...
  const boxesMap = boxes.map((box, index) => (
    <ContainerBlue key={index} isNew={box.isNew} name={box.name} />
  ));

  return (
    <section className="containerBlue" id="service">
...
export default ContainerBlueList;
